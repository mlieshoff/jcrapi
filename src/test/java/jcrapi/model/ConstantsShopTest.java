...
public class ConstantsShopTest {

  private ConstantsShop unitUnderTest;

  @Before
  public void setUp() {
    unitUnderTest = new ConstantsShop();
  }
  ...
  public void shouldToString() {
    ...
    String expected = "ConstantsShop(arena=" + new ConstantsArena() + ", arenas=" + new java.util.ArrayList<ConstantsArena>() + ", baseChest=astring, boostedChest=false, cardCount=4711, chestCountInChestCycle=4711, description=astring, differentSpells=4711, draftChest=false, epicChance=4711, exp=4711, guaranteedSpells=astring, inArenaInfo=false, inShop=false, legendaryChance=4711, legendaryOverrideChance=4711, maxGold=4711, maxGoldPerCard=4711, minGold=4711, minGoldPerCard=4711, name=astring, randomSpells=4711, rareChance=4711, shopPriceWithoutSpeedUp=4711, skinChance=4711, sortValue=4711, specialOffer=false, spellSet=astring, survivalChest=false, timeTakenDays=4711, timeTakenHours=4711, timeTakenMinutes=4711, timeTakenSeconds=4711, tournamentChest=false)";
