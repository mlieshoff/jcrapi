...
public class ConstantsTroopTest {
  ...
  public void shouldToString() {
    ...
    String expected = "ConstantsTroop(allTargetsHit=false, arena=4711, attacksAir=false, attacksGround=false, buildingTarget=false, burstAffectAnimation=false, burstKeepTarget=false, collisionRadius=4711, crowdEffects=false, damage=4711, dashOnlyOnce=false, deathInheritIgnoreList=false, deathSpawnPushback=false, deployTime=4711, description=astring, destroyAtLimit=false, dontStopMoveAnim=false, dps=1.41, elixir=4711, flyDirectPaths=false, flyFromGround=false, hasRotationOnTimeline=false, healOnMorph=false, hideBeforeFirstHit=false, hidesWhenNotAttacking=false, hitSpeed=4711, hitpoints=4711, id=4711, ignorePushback=false, SummonerTower=false, jumpEnabled=false, kamikaze=false, key=astring, loadAfterRetarget=false, loadFirstHit=false, loadTime=4711, mass=4711, morphKeepTarget=false, name=astring, nameEn=astring, projectileStartRadius=4711, projectileStartZ=4711, range=4711, rarity=astring, retargetAfterAttack=false, scale=4711, selfAsAoeCenter=false, showHealthNumber=false, sightRange=4711, spawnAttach=false, spawnConstPriority=false, spawnEffectOnce=false, specialAttackWhenHidden=false, speed=4711, speedEn=astring, targetOnlyBuildings=false, type=astring)";
