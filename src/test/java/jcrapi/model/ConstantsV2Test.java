...
public class ConstantsV2Test {

  private ConstantsV2 unitUnderTest;

  @Before
  public void setUp() {
    unitUnderTest = new ConstantsV2();
  }
  ...
  public void shouldToString() {
    ...
    String expected = "ConstantsV2(cards=" + new java.util.ArrayList<Long>() + ", gold=" + new java.util.ArrayList<Long>() + ", thresholds=" + new java.util.ArrayList<Long>() + ")";
