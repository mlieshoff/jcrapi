...
public class CardTest {
    ...
    public void shouldToString() {
        ...
        String expected = "Card{name=astring, level=815, maxLevel=815, count=815, iconUrls=" + new IconUrls() + ", key=astring, elixir=815, type=astring, rarity=astring, arena=815, description=astring}";
