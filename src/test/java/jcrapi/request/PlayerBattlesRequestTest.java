 ...
 */
public class PlayerBattlesRequestTest extends LimitedRequestTestBase<PlayerBattlesRequest, PlayerBattlesRequest.PlayerBattlesRequestBuilder> {

    @Override
    PlayerBattlesRequest.PlayerBattlesRequestBuilder getBuilder() {
