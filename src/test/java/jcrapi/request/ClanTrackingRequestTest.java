 ...
 */
public class ClanTrackingRequestTest extends RequestTestBase<ClanTrackingRequest, ClanTrackingRequest.ClanTrackingRequestBuilder> {

    @Override
    ClanTrackingRequest.ClanTrackingRequestBuilder getBuilder() {
